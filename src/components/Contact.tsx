    ...
    <section id="contato" className="py-16 sm:py-20 lg:py-24 bg-gradient-section">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
          {/* Contact Info */}
          <div className="space-y-5 sm:space-y-6 lg:space-y-8 animate-fade-in-left">
          ...
          <div className="animate-fade-in-right">
            <div className="rounded-xl sm:rounded-2xl overflow-hidden shadow-card h-[300px] sm:h-[350px] lg:h-full lg:min-h-[400px]">
              <iframe
