    ...
    <section className="relative py-16 sm:py-20 lg:py-24 text-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Rating Display */}
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl sm:rounded-3xl p-5 sm:p-8 md:p-10 lg:p-12 animate-scale-in">
            ...
            <Button size="lg" variant="outline" asChild className="border-white bg-white/20 text-white hover:bg-white hover:text-foreground w-full sm:w-auto">
              <a
